...
3. **Start** drücken, sobald die Suche fertig ist. Fortschritt pro Video im Fenster; am Ende eine Zusammenfassung. Videos, die schon Untertitel in der Sprache haben, werden übersprungen — mehrfaches Ausführen ist unkritisch. Das gilt für externe Dateien wie `Film.de.srt`, `Film.ger.srt` oder `Film.srt`, bei der die Sprache aus dem Text erkannt wird, und für im Video eingebettete Untertitelspuren, die in der Tabelle als „eingebettet" erscheinen. Geprüft werden nur die gewählten Sprachen; Forced-Spuren und Spuren ohne Sprachkennung zählen absichtlich nicht, sie ersetzen keinen vollständigen Untertitel. Wer trotzdem externe Dateien will, schaltet die eingebetteten Spuren in den Einstellungen ab. Eine Checkbox unter der Tabelle blendet Videos aus, die schon alles haben.
